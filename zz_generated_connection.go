...
var scopes = []string{"https://servicebus.azure.net/.default"}
...
// connection - Azure Service Bus client for managing Queues, Topics, and Subscriptions.
